...
export async function UpdateTodo(
  ...
  context.log(
    `Http function processed request for url "${request.url}" and method "${request.method}"`
  );

  const params = TodoParamIDSchema.safeParse(
...
registerFunction("UpdateTodo", "Update Single Todo", {
  handler: UpdateTodo,
  methods: ["PUT", "PATCH"],
  authLevel: "anonymous",
